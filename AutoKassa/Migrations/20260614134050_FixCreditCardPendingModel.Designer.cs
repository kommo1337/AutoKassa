...
namespace AutoKassa.Migrations
{
    ...
    [Migration("20260614134050_FixCreditCardPendingModel")]
    partial class FixCreditCardPendingModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoKassa.Models.CreditCard", b =>
                {
                    ...
                    b.Property<decimal>("MinimumPaymentPercent")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("AutoKassa.Models.CreditCardPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AutoKassa.Models.Transaction", b =>
                {
                    ...
                    b.HasIndex("Date", "Type", "IsDeleted")
                        .HasDatabaseName("IX_Transaction_Date_Type_IsDeleted");

                    b.HasIndex("Type", "IsDeleted", "Date")
            ...
            modelBuilder.Entity("AutoKassa.Models.CreditCardPurchase", b =>
                {
                    ...
                    b.HasOne("AutoKassa.Models.Transaction", "Transaction")
                        .WithMany()
