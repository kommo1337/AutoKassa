...
[![Release](https://img.shields.io/static/v1?label=version&message=v1.1.0&color=blue&logo=github)](https://github.com/kommo1337/AutoKassa/releases)
...
| **💳 Кредитные карты** | Учёт карт, лимитов, кредитных покупок, минимальных платежей и погашений |
| **🧾 Сверка кассы** | Проверка наличных, безналичных, кредитного долга и чистого баланса на дату |
...
| **🔐 Безопасность** | BCrypt-хеширование паролей, секретный вопрос, автоблокировка по таймауту |
